...
const char HTTP_FORM_START[] PROGMEM      = "<form method=\"get\" action=\"wifisave\"><label>SSID</label><input id=\"s\" name=\"s\" length=32 placeholder=\"SSID\" type=\"text\" autocorrect=\"off\" autocapitalize=\"none\"><label>Password</label><input id=\"p\" name=\"p\" length=64 placeholder=\"password\" type=\"text\" autocorrect=\"off\" autocapitalize=\"none\">";
